...
<div class="body_wrap">
	...
	<div class="header">   
        ...
        <div class="header_top">
			<div class="container">
                <div class="logo"><a href="index.html"><img src="HTML/images/col_icon_2.png" width="210" height="80" alt="Medica" /></a></div>
...
<div class="aligncenter" align="center">
                    ...
                    <div class="widget-container widget_login" align="left">
                      ...
                      <form action="logar.php" method="post" id="loginform" class="loginform">
                        
                        <p><label>Usu&aacute;rio</label><br />
                        <input name="usuario" id="usuario" class="input" value="" size="20" tabindex="10" type="text"></p>
						<p><label>Senha</label><br />
                        <input name="senha" id="senha" class="input" value="" size="20" tabindex="20" type="password"/></p>
                        
                        <p class="forget_password"><a href="esqueceu_senha.php">Esqueceu a senha?</a></p>   
