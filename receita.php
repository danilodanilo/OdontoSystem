				...
				<table id="tabela" width="50%" cellpadding="0" cellspacing="0">
					...
					if ($sql){
						for($i=0;$i<$count_sql;$i++){
							...
							echo '<tr>';
							echo "<td><a href='receita.php?nome_paciente=$nome_p'><img title='Selecionar Paciente' border='0' src='icon_check2.png' width='15' height='10'></a>
					...
					<div class="topmenu" align="left">
						<ul class="dropdown">
							...
							<li class="menu-item-home parent current-menu-ancestor"><a href="#"><span>Outros Servi&ccedil;os</span> </a>
								<ul>
									<li class="current-menu-item"><a href="receita.php"><span>Gerar Receita</span> </a></li>
					...
					<div class="grid_8 content">
						<div class="post-item">
							<div class="contact-form" align="left" width="100px">
								<form action="gerar_receita_pdf.php" method="post"
									name="gerar_receita">

									<h1>
										<br>Receita M&eacute;dica</br>
									</h1>
									...
									<div class="row field_textarea alignleft">
										<label><strong>Receita</strong> </label><br />
										<textarea id="receita" name="receita"
										...
										<div class="row">
											<div class="entry">
												...
												if(!empty($nome_paciente)){
													echo '<input value="Gerar Receita" title="Gerar PDF da receita"
